...
## Quiz
Which of the following best demonstrates a well-structured recommendation based on a predictive insight?
a - “Customers with high credit utilization are risky.”
b - “Offer a payment deferral to all customers flagged as high-risk.”
*c - “Launch a 6-week SMS outreach pilot targeting customers under 30 with 2+ missed payments, aiming to reduce 30-day delinquency by 10%.”*
d - “Analyze the impact of missed payments across all segments.”

When presenting AI-driven insights to a non-technical stakeholder, which approach is most effective?
a - Use technical terminology to show model accuracy and depth.
b - Begin with how the model was trained and which algorithm was used.
c - Focus on the model's F1 score and confusion matrix in detail.
*d - Highlight the key risk pattern and link it to a relevant business action in plain language.*

Which of the following reflects a responsible approach to using a predictive model in financial services?
a - Prioritising model accuracy above all else.
b - Automatically applying the model’s output to all customers without review.
*c - Reviewing whether the model introduces bias or unfair treatment across different customer groups.*
d - Using only complex models, as they are more powerful.
