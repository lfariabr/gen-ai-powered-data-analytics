...
Tags: #genai #dataanalytics #python #machinelearning #career

After completing the [Commonwealth Bank Software Engineering Challenge](https://dev.to/lfariaus/how-i-tackled-the-commonwealths-bank-software-engineering-challenge-3ebk) and my [AWS Solutions Architect journey](https://dev.to/lfariaus/scaling-fastier-my-aws-solutions-architect-journey-with-forage-challenge-30j8), I was hungry for the next one. That's when I discovered **Tata's GenAI Powered Data Analytics simulation on Forage**.
...
> **Want to jump in yourself?** Check out the simulation [here](https://www.theforage.com/simulations/tata/data-analytics-t3zr) before reading. **SPOILER ALERT** ahead!
...
👉 [Open Source Code (GitHub)](https://github.com/lfariabr/gen-ai-powered-data-analytics)
...
1. **Start with the business problem**: Every model decision should trace back to impact
2. **GenAI amplifies, doesn't replace**: Use it as a thinking partner, not a crutch
3. **Explainability > Complexity**: The best models are ones stakeholders trust
4. **Ethics aren't optional**: Fairness and compliance must be baked in from day one
5. **Ship something real**: I didn't just write reports—I built a working Streamlit app
